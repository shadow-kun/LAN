		...
		<thead>
			<tr>
				...
				<th width="10%" >
					...
					<?php echo JHTML::_('grid.order', $this->items, 'filesave.png', 'stores.saveorder'); ?>
				</th>
				<th width="10%">
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if($item->checked_out) : ?>
						<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'stores.', $canEdit); ?>
					<?php endif; ?>
					<?php if ($canCreate || $canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_events&task=store.edit&id=' . $item->id); ?>">
				...
				<td class="center">
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'store.', $canChange); ?>
				</td>

<?php defined('_JEXEC') or die('Restricted access');
	 ...
	 * @since   12.1
	 */
	class EventsModelsStores extends EventsModelsDefault
	{
		/**
		 * Get the time.
		 *
		...
		public function listStores($event = null)
		{
			$db		= $this->getDb();
			...
			$query->select(
				$this->getState(
					'list.select', 'a.id, a.title, a.alias, a.body, a.checked_out, a.checked_out_time, ' . 

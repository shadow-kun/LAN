...
<div id="sources">
	...
	<?php echo JText::_('COM_EVENTS_CHECKIN_SOURCE_REGISTRATION_ID_LABEL', true) . ':'; ?><input id="checkin_registration_id" name="registration_id" ></input>
	...
	<select id="eventid" >
		...
		endforeach; ?>
	<select>
	<p><a href="javascript:void(0);" onclick="checkinSearchEntry()" class="btn btn-primary"><?php echo JText::_('COM_EVENTS_CHECKIN_SOURCE_SEARCH_LABEL', true); ?></a></p>
</div>
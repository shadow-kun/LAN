	...
	<?php if(JFactory::getUser()->guest) { 
		...
		if(isset($this->currentUser->id))
		{
			if($this->currentUser->status == 4)
			{
				...
				echo '<a class="btn" onclick="showOptionTeamDelete()" href="'. JRoute::_('index.php?option=com_events&view=team&layout=delete&id=' . JRequest::getVar('id')) . '" >' . JText::_('COM_EVENTS_TEAM_SUMMARY_DELETE_LABEL', true) . '</a></p>';
			}
